...
class SpecialOffersSpider(scrapy.Spider):
    ...
    def start_requests(self):
        yield scrapy.Request(url='https://www.cigabuy.com/specials.html', callback=self.parse,headers={'User-Agent':'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.114 Safari/537.36'})
    ...
    def parse(self, response):
        ...
        if next_page:
            ...
            #paste the same request headers here